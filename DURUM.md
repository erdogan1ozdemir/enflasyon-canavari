...
2. ⏳ Karşılaştır ekranı düzeltmeleri (TÜFE hedefi çıkar, yıl-seçici taşması, akıllı varsayılan)
...
- Karşılaştır: TÜFE "neyi alır" hedefi olarak görünüyor (anlamsız); yıl seçiciler kartı taşırıyor; varsayılan kombo boş geliyor. → Faz 3 / Adım 2
- Hesapla: yalnızca "o gün→bugün" yönü var. → Adım 3
